  ...
  class CEP47Client {
    ...
    constructor(
      ...
      this.contractClient.setContractHash(
        'hash-20ed01fc1bd372018b76518b298bee7bc4b348fc78d5cfb3938fcd52cefe560d',
        'hash-d9b6887e2c4c31a647f9435d3f86cc9433267f117fe8ae227629e0e601ac6ce9'
      );
    ...
    public async getCampaign(tokenId: string) {
      const result = await this.contractClient.queryContractDictionary(
        'campaign',
        tokenId
      );
