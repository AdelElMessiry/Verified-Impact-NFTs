  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>{data.isForSale=="true"?"UnList":"List"} {data.title} NFT For Sale</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className='reserve-form'>
          ...
          {data.isForSale=="true"?<span>Are you sure you want to unlist {data.title} for sale?</span>:  <div className='row form-group justify-content-center'>
            <div className='col-6'>
              <input
                type='text'
      ...
      <Modal.Footer>
        ...
        <button className='btn btn-success' onClick={() => {ListNFTForSale()}}>
         {data.isForSale=="true"?"UnList NFT For Sale":"List NFT For Sale"} 
        </button>
      </Modal.Footer>
    </Modal>
  );
